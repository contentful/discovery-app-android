...
public class CredentialsLoader extends AbsAsyncTaskLoader<LinkedHashSet<Credentials>> {
    @Override
    protected LinkedHashSet<Credentials> performLoad() {
        SQLiteDatabase db = DBHelper.getInstance().getReadableDatabase();

        String[] columns = new String[]{
                CredentialsTable.Columns.SPACE_NAME,
                CredentialsTable.Columns.SPACE,
                CredentialsTable.Columns.TOKEN,
                CredentialsTable.Columns.LAST_LOGIN
        };
        ...
        try {
            cursor = db.query(CredentialsTable.NAME, columns,
            ...
            if (cursor.moveToFirst()) {
                ...
                do {
                    loadResult.add(new Credentials(
                            cursor.getString(spaceNameIndex),
                            cursor.getString(spaceIndex),
