...
public class AssetInfoAdapter extends BaseAdapter {
    ...
    private final static HashSet<String> clickableTitles = new HashSet<String>(
    ...
    public AssetInfoAdapter(Context context, CDAAsset asset) {
        ...
        Double sizeInBytes = (Double) ((Map) ((Map) assetFields.get("file")).get("details")).get("size");
        String displaySize = FileUtils.byteCountToDisplaySize(sizeInBytes.longValue());

        fields.add(new Pair<String, String>(context.getString(R.string.asset_info_size),
                displaySize));
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        boolean clickable = clickableTitles.contains(item.first);
        convertView.setTag(R.id.tag_clickable, clickable);
        vh.ivArrow.setVisibility(clickable ? View.VISIBLE : View.GONE);
