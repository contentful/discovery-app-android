...
public class GenericViewFactory extends PreviewViewFactory<GenericViewHolder> {
    ...
    @Override
    protected GenericViewHolder createViewHolder(Object factoryKey, View v) {
        return new GenericViewHolder(factoryKey, v);
    }

    @Override
    protected void setViewData(GenericViewHolder viewHolder, DisplayItem displayItem) {
    ...
    private void setLinkData(GenericViewHolder viewHolder, DisplayItem displayItem) {
        ...
        if (displayItem.resource instanceof CDAAsset) {
            ...
            Utils.loadThumbnailForAssetWithSize(
                    viewHolder.rootView.getContext(),
                    (CDAAsset) displayItem.resource,
    ...
    @Override
    public void reset(GenericViewHolder viewHolder) {
