...
public class ArrayViewFactory extends PreviewViewFactory<ArrayViewHolder> {
    ...
    @Override
    protected ArrayViewHolder createViewHolder(Object factoryKey, View v) {
        return new ArrayViewHolder(factoryKey, v);
    }

    @Override
    protected void setViewData(ArrayViewHolder viewHolder, DisplayItem displayItem) {
        ...
        for (Object node : displayItem.array) {
            ...
            if (node instanceof CDAEntry) {
                viewHolder.wrapper.addView(
                        createTextView(viewHolder.rootView.getContext(),
                                ((CDAEntry) node).getSys().get("id")));
            }
        }
    }
    ...
    @Override
    public void reset(ArrayViewHolder viewHolder) {
