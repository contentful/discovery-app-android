...
public class RTFViewFactory extends PreviewViewFactory<RTFViewHolder> {
    ...
    @Override
    protected RTFViewHolder createViewHolder(Object factoryKey, View v) {
    ...
    @Override
    protected void setViewData(RTFViewHolder viewHolder, DisplayItem displayItem) {
        viewHolder.webView.loadDataWithBaseURL(
                CFApp.getInstance().getString(R.string.url_contentful),
                displayItem.displayValue,
                TextPreviewActivity.MIME_TYPE_TEXT_HTML,
                CharEncoding.UTF_8,
                null);
    ...
    @Override
    public void reset(RTFViewHolder viewHolder) {
